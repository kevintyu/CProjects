...
int main(int argc, char *argv[]) {
  ...
  // while(1){
  //   if (argc != 3){
  //     printf("Error with arguements\n");
  //     exit(-1);
  //   }
  //   if (atoi(argv[2]) > 5 || atoi(argv[2]) < 1) {
  //     printf("Error no such environment\n");
  //     exit(-1);
  //   }
  //   if (atoi(argv[1]) < 5 || atoi(argv[1]) > 500){
  //     printf("Error not a valid grid size\n");
  //     exit(-1);
  //   }
  //   else{
  //       break;
  ...
  // }
  //
  // 	environmentNumber = atoi(argv[2]);
	// environment.gridSize = atoi(argv[1]);
